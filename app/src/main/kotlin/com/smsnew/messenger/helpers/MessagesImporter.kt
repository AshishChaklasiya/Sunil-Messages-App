...
import com.smsnew.messenger.commonsLibCustom.helpers.isUpsideDownCakePlus
import com.smsnew.messenger.dialogs.ImportMessagesDialog
        ...
        try {
            ...
            when {
                messagesFailed > 0 && messagesImported > 0 -> {
                    activity.toast(R.string.importing_some_entries_failed)
                }
