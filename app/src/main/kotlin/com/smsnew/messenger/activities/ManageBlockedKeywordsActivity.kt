...
import com.smsnew.messenger.commonsLibCustom.helpers.ExportResult
...
import com.smsnew.messenger.databinding.ActivityManageBlockedKeywordsBinding
import com.smsnew.messenger.dialogs.AddBlockedKeywordDialog
import com.smsnew.messenger.dialogs.ExportBlockedKeywordsDialog
import com.smsnew.messenger.dialogs.ManageBlockedKeywordsAdapter
import com.smsnew.messenger.extensions.config
import com.smsnew.messenger.extensions.toArrayList
import com.smsnew.messenger.helpers.BlockedKeywordsExporter
import com.smsnew.messenger.helpers.BlockedKeywordsImporter
...
class ManageBlockedKeywordsActivity : SimpleActivity(), RefreshRecyclerViewListener {
    ...
    private fun importBlockedKeywords(path: String) {
        ensureBackgroundThread {
            ...
            toast(
                when (result) {
                    BlockedKeywordsImporter.ImportResult.IMPORT_OK -> R.string.importing_successful
                    BlockedKeywordsImporter.ImportResult.IMPORT_FAIL -> R.string.no_items_found
                }
            )
            updateBlockedKeywords()
        }
