...
import com.smsnew.messenger.adapters.AttachmentsAdapter
import com.smsnew.messenger.adapters.AutoCompleteTextViewAdapter
import com.smsnew.messenger.adapters.ThreadAdapter
...
import com.smsnew.messenger.commonsLibCustom.dialogs.RadioGroupDialog
import com.smsnew.messenger.commonsLibCustom.dialogs.RadioGroupIconDialog
...
import com.smsnew.messenger.databinding.ActivityThreadBinding
import com.smsnew.messenger.databinding.ItemSelectedContactBinding
import com.smsnew.messenger.dialogs.InvalidNumberDialog
import com.smsnew.messenger.dialogs.RenameConversationDialog
import com.smsnew.messenger.dialogs.ScheduleMessageDialog
import com.smsnew.messenger.extensions.*
import com.smsnew.messenger.helpers.*
import com.smsnew.messenger.messaging.*
import com.smsnew.messenger.models.*
...
//                    binding.messageHolder.threadTypeMessage.requestFocusFromTouch()
    ...
    private fun setupAdapter() {
        ...
        binding.addContactOrNumber.setBackgroundResource(R.drawable.search_bg)
    ...
    private fun setupSIMSelector() {
        ...
        if (availableSIMs.size > 1) {
            ...
            binding.messageHolder.threadSelectSimIcon.background.applyColorFilter(
                resources.getColor(R.color.activated_item_foreground, theme)
            )
...
//    }
    ...
    private fun blockNumber() {
        ...
        val baseString =
            if (isBlockNumbers) R.string.unblock_confirmation
    ...
    private fun getThreadItems(): ArrayList<ThreadItem> {
        ...
        for (message in messagesCopy) {
            ...
            if (message.date - prevDateTime > MIN_DATE_TIME_DIFF_SECS || isSentFromDifferentKnownSIM) {
                ...
                items.add(ThreadItem.ThreadDateTime(message.date, simCardID))
...
//                conversationsDB.markRead(threadId)
    ...
    private fun addContactAttachment(contactUri: Uri) {
        val items = arrayListOf(
            RadioItem(1, getString(R.string.file)),
            RadioItem(2, getString(R.string.text))
        )
...
//            }
    ...
    private fun setupAttachmentPickerView() = binding.messageHolder.attachmentPicker.apply {
        val buttonColors = arrayOf(
            if (isDynamicTheme()) R.color.you_neutral_text_color
            else if (isLightTheme() || isGrayTheme()) R.color.theme_dark_background_color
            else R.color.white,
        ...
        arrayOf(
            ...
            if (index == 5) icon.applyColorFilter(ResourcesCompat.getColor(resources, R.color.ic_messages, theme))
        }
