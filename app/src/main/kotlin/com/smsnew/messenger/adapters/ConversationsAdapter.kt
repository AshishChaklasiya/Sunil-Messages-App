...
import com.smsnew.messenger.messaging.cancelScheduleSendPendingIntent
    ...
    override fun prepareActionMode(menu: Menu) {
        ...
        menu.apply {
            ...
            findItem(R.id.cab_dial_number).isVisible =
                isSingleSelection && !isGroupConversation && !isShortCodeWithLetters(
...
//                activity.markThreadMessagesUnread(conversation.threadId)
    ...
    private fun swipedCall(conversation: Conversation) {
        if (conversation.isGroupConversation || isShortCodeWithLetters(conversation.phoneNumber)) activity.toast(R.string.no_phone_number_found)
        else {
            activity.dialNumber(conversation.phoneNumber)
            finishActMode()
        }
