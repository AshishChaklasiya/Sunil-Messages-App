...
import com.smsnew.messenger.databinding.DialogMessageBubbleSettingBinding
import com.smsnew.messenger.extensions.config
import com.smsnew.messenger.helpers.BUBBLE_STYLE_IOS
import com.smsnew.messenger.helpers.BUBBLE_STYLE_IOS_NEW
import com.smsnew.messenger.helpers.BUBBLE_STYLE_ORIGINAL
import com.smsnew.messenger.helpers.BUBBLE_STYLE_ROUNDED
...
class MessageBubbleSettingDialog(
    ...
    init {
        ...
        activity.getAlertDialogBuilder()
            ...
            .apply {
                activity.setupDialogStuff(binding.root, this, R.string.speech_bubble) { alertDialog ->
                    dialog = alertDialog
                }
            }
    }
    ...
    private fun isNotPro() {
        ...
        val snackbar = Snackbar.make(binding.root, R.string.support_project_to_unlock, Snackbar.LENGTH_SHORT)
            .setAction(R.string.support) {
                dialog?.dismiss()
            }

        val bgDrawable = when {
            activity.isDynamicTheme() -> ResourcesCompat.getDrawable(binding.root.resources, R.drawable.dialog_bg, null)
            else -> ResourcesCompat.getDrawable(binding.root.resources, R.drawable.button_background_16dp, null)
        }
