...
import com.smsnew.messenger.commonsLibCustom.helpers.MyContentProvider.FONTS_URI
...
import com.smsnew.messenger.commonsLibCustom.models.isGlobalThemingEnabled
import com.smsnew.messenger.databinding.ActivityCustomizationBinding
import java.io.File
...
//                    curPrimaryColor == getColor(value.primaryColorId) &&
    ...
    private fun saveChanges(finishAfterSave: Boolean) {
        ...
        if (isProVersion()) saveThankYouChanges()
...
//                    updateColorTheme(getCurrentThemeId())
    ...
    private fun getCurrentSurfaceColor(): Int {
        val bottomColor = when {
            ...
            curBackgroundColor == resources.getColor(R.color.theme_dark_background_color, theme) -> resources.getColor(
                R.color.bottom_tabs_dark_background,
                theme
            )
