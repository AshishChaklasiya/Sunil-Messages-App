...
import com.smsnew.messenger.commonsLibCustom.extensions.contactsDB
import com.smsnew.messenger.commonsLibCustom.extensions.getByteArray
import com.smsnew.messenger.commonsLibCustom.extensions.getEmptyContact
    ...
    companion object {
        fun convertContactToSimpleContact(contact: Contact?, withPhoneNumbersOnly: Boolean): SimpleContact? {
            return if (contact == null || (withPhoneNumbersOnly && contact.phoneNumbers.isEmpty())) {
                ...
                val jobPosition = contact.organization.jobPosition
                SimpleContact(
                    contact.id,
                    contact.id,
