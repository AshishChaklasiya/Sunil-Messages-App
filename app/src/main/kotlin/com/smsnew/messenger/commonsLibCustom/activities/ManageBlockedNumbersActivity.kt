...
import com.smsnew.messenger.commonsLibCustom.compose.extensions.enableEdgeToEdgeSimple
import com.smsnew.messenger.commonsLibCustom.compose.extensions.onEventValue
import com.smsnew.messenger.commonsLibCustom.compose.screens.ManageBlockedNumbersScreen
import com.smsnew.messenger.commonsLibCustom.compose.theme.AppThemeSurface
import com.smsnew.messenger.commonsLibCustom.dialogs.AddOrEditBlockedNumberAlertDialog
import com.smsnew.messenger.commonsLibCustom.dialogs.ExportBlockedNumbersDialog
import com.smsnew.messenger.commonsLibCustom.dialogs.RadioGroupAlertDialog
            ...
            AppThemeSurface {
                ...
                blockingTypeDialogState.DialogMember {
                    RadioGroupAlertDialog(
                        ...
                        items = if (isQPlus()) {
                            listOf(
                                RadioItem(BLOCKING_TYPE_REJECT, stringResource(id = R.string.blocking_type_reject)),
                                RadioItem(BLOCKING_TYPE_DO_NOT_REJECT, stringResource(id = R.string.blocking_type_do_not_reject)),
                                RadioItem(BLOCKING_TYPE_SILENCE, stringResource(id = R.string.blocking_type_silence)),
                            ).toImmutableList()
                        } else {
                            listOf(
                                RadioItem(BLOCKING_TYPE_REJECT, stringResource(id = R.string.blocking_type_reject)),
                        ...
                        titleId = R.string.blocking_type,
                        cancelCallback = {}
                    ) { item ->
