...
val theme_gray_text_color = md_grey_900
val theme_gray_background_color = Color(0xFFebebeb)
val theme_dark_text_color = md_grey_200
val theme_dark_background_color = Color(0xFF1E2225) //md_grey_800_dark
val theme_black_text_color = md_grey_200
val theme_black_background_color = Color(0xFF000000)
...
val theme_light_navigation_color = theme_light_background_color //#d6d6d6
val theme_gray_navigation_color = theme_gray_background_color //#c7c7c7
...
//Goodwy
val bw_10 = Color(0xffffffff)
val bw_20 = Color(0xfffefefe) //add
val bw_30 = Color(0xffeeeeee) //add
val bw_40 = Color(0xffdedede) //add
val bw_50 = Color(0xffcccccc)
val bw_60 = Color(0xffb8b8b8)
val bw_70 = Color(0xffacacac) //add
val bw_80 = Color(0xffa3a3a3)
val bw_90 = Color(0xff8f8f8f)
val bw_100 = Color(0xff848484) //add
val bw_200 = Color(0xff7a7a7a)
val bw_300 = Color(0xff666666)
val bw_400 = Color(0xff5a5a5a) //add
val bw_500 = Color(0xff525252)
val bw_600 = Color(0xff3d3d3d)
val bw_700 = Color(0xff323232) //add
val bw_800 = Color(0xff292929)
val bw_900 = Color(0xff141414)
val bw_000 = Color(0xff000000)

val blue_100 = Color(0xff0b2432)
val blue_200 = Color(0xff215169)
val blue_300 = Color(0xff3b85a9)
val blue_400 = Color(0xff4fb7e9) //5bc6f8
val blue_500 = Color(0xff61c5f9)
val blue_600 = Color(0xff75d4fa)
val blue_700 = Color(0xff8cdafa)
val blue_800 = Color(0xffabe5fc)
val blue_900 = Color(0xffc0eafc)

val indigo_100 = Color(0xff030f2a)
val indigo_200 = Color(0xff081e54)
val indigo_300 = Color(0xff123285)
val indigo_400 = Color(0xff1f4dbd)
val indigo_500 = Color(0xff2960f5)
val indigo_600 = Color(0xff437df6)
val indigo_700 = Color(0xff6696f7)
val indigo_800 = Color(0xff8db0f8)
val indigo_900 = Color(0xffadc3f9)

val deep_purple_100 = Color(0xff0f0233)
val deep_purple_200 = Color(0xff22036e)
val deep_purple_300 = Color(0xff3205a9)
val deep_purple_400 = Color(0xff3c17c6)
val deep_purple_500 = Color(0xff724fd5)
val deep_purple_600 = Color(0xff836cdd)
val deep_purple_700 = Color(0xffa589ef)
val deep_purple_800 = Color(0xffbaadef)
val deep_purple_900 = Color(0xffcec4f6)

val purple_100 = Color(0xff210233)
val purple_200 = Color(0xff490a69)
val purple_300 = Color(0xff7214a1)
val purple_400 = Color(0xff851ebf)
val purple_500 = Color(0xffa44ace)
val purple_600 = Color(0xffae65d7)
val purple_700 = Color(0xffc186e1)
val purple_800 = Color(0xffd5a8ed)
val purple_900 = Color(0xffe3c3f5)

val pink_100 = Color(0xff280913)
val pink_200 = Color(0xff531327)
val pink_300 = Color(0xff82203e)
val pink_400 = Color(0xffb42e58)
val pink_500 = Color(0xffc25076)
val pink_600 = Color(0xffcc6c90)
val pink_700 = Color(0xffd88aa8)
val pink_800 = Color(0xffe4adc2)
val pink_900 = Color(0xffefc5d6)

val red_100 = Color(0xff230501)
val red_200 = Color(0xff490e05)
val red_300 = Color(0xff72190c)
val red_400 = Color(0xffa02715)
val red_500 = Color(0xffd74022)
val red_600 = Color(0xffeb5232)
val red_700 = Color(0xffec6e54)
val red_800 = Color(0xffef9281)
val red_900 = Color(0xfff1aca5)

val deep_orange_100 = Color(0xff250e02)
val deep_orange_200 = Color(0xff4d1e07)
val deep_orange_300 = Color(0xff782e10)
val deep_orange_400 = Color(0xffa9461c)
val deep_orange_500 = Color(0xffed732e)
val deep_orange_600 = Color(0xffed7e3d)
val deep_orange_700 = Color(0xfff0955f)
val deep_orange_800 = Color(0xfff3b08b)
val deep_orange_900 = Color(0xfff5c3a9)

val orange_100 = Color(0xff281904)
val orange_200 = Color(0xff52330c)
val orange_300 = Color(0xff805219)
val orange_400 = Color(0xffb57929)
val orange_500 = Color(0xffe8a12d) //f6cb45
val orange_600 = Color(0xfff2b14b)
val orange_700 = Color(0xfff5c068)
val orange_800 = Color(0xfff7d08f)
val orange_900 = Color(0xfff9dbad)

val amber_100 = Color(0xff281d04)
val amber_200 = Color(0xff533e10)
val amber_300 = Color(0xff82631e)
val amber_400 = Color(0xffb9902f)
val amber_500 = Color(0xfff2c22f) //f6cb45
val amber_600 = Color(0xfff5cc52)
val amber_700 = Color(0xfff7d46e)
val amber_800 = Color(0xfff9e093)
val amber_900 = Color(0xfffae6b0)

val yellow_100 = Color(0xff222005)
val yellow_200 = Color(0xff45420f)
val yellow_300 = Color(0xff6a651c)
val yellow_400 = Color(0xff928c2b)
val yellow_500 = Color(0xffc8c12b) //bdbb3c
val yellow_600 = Color(0xffe7df32) //fdf653
val yellow_700 = Color(0xfffcf552) //fdf763
val yellow_800 = Color(0xfffbf685)
val yellow_900 = Color(0xfffefaa5)

val lime_100 = Color(0xff21240a)
val lime_200 = Color(0xff444816)
val lime_300 = Color(0xff697024)
val lime_400 = Color(0xff919933)
val lime_500 = Color(0xffb8c743)
val lime_600 = Color(0xffdce757)
val lime_700 = Color(0xffe8f072)
val lime_800 = Color(0xffeff497)
val lime_900 = Color(0xfff6fab3)

val green_100 = Color(0xff1f2b14)
val green_200 = Color(0xff35491e)
val green_300 = Color(0xff52732f)
val green_400 = Color(0xff719e3f)
val green_500 = Color(0xff89bd56)
val green_600 = Color(0xff9fc96f)
val green_700 = Color(0xffb5d68e)
val green_800 = Color(0xffcce4ae)
val green_900 = Color(0xffdcefc5)

//letterBackgroundColors
val random_100 = Color(0xFF8CDAFA)
val random_200 = Color(0xFF5D99FF)
val random_300 = Color(0xFFA589EF)
val random_400 = Color(0xFFFF6969)
val random_500 = Color(0xFFFF8963)
val random_600 = Color(0xFFF1AF28)
val random_700 = Color(0xFFF7DF32)
val random_800 = Color(0xFF06C9AF)

//letterBackgroundColors Arc
val random_arc_100 = Color(0xFF6DBAD9)
val random_arc_200 = Color(0xFF666789)
val random_arc_300 = Color(0xFFA6729E)
val random_arc_400 = Color(0xFFF29BBB)
val random_arc_500 = Color(0xFFF25E6B)
val random_arc_600 = Color(0xFFFF8558)
val random_arc_700 = Color(0xFFF8D558)
val random_arc_800 = Color(0xFF34E895)

//letterBackgroundColors Android
val random_android_100 = Color(0xFF00D0EA)
val random_android_200 = Color(0xFF0075F0)
val random_android_300 = Color(0xFFBC56FF)
val random_android_400 = Color(0xFFFF54BB)
val random_android_500 = Color(0xFFFF5B55)
val random_android_600 = Color(0xFFFF891D)
val random_android_700 = Color(0xFFFFC600)
val random_android_800 = Color(0xFF26BC6D)

//letterBackgroundColors iOS
val random_ios_100 = Color(0xFF64D1FF)
val random_ios_200 = Color(0xFF0B84FE)
val random_ios_300 = Color(0xFF5D5CE6)
val random_ios_400 = Color(0xFFBF5AF3)
val random_ios_500 = Color(0xFFFE375E)
val random_ios_600 = Color(0xFFFF5713)
val random_ios_700 = Color(0xFFFE9F0C)
val random_ios_800 = Color(0xFF2ED158)
