...
import com.smsnew.messenger.commonsLibCustom.adapters.FilePickerFavoritesAdapter
import com.smsnew.messenger.commonsLibCustom.adapters.FilepickerItemsAdapter
...
import com.smsnew.messenger.commonsLibCustom.views.Breadcrumbs
import com.smsnew.messenger.databinding.DialogFilepickerBinding
import java.io.File
...
class FilePickerDialog(
    ...
    private fun showFavorites() {
        mDialogView.apply {
            ...
            val drawable =
                activity.resources.getColoredDrawableWithColor(activity, R.drawable.ic_folder_vector, activity.getProperPrimaryColor().getContrastColor())
    ...
    private fun hideFavorites() {
        mDialogView.apply {
            ...
            val drawable =
                activity.resources.getColoredDrawableWithColor(activity, R.drawable.ic_star_vector, activity.getProperPrimaryColor().getContrastColor())
            filepickerFabShowFavorites.setImageDrawable(drawable)
        }
    }
