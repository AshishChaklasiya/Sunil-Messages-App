...
import com.smsnew.messenger.commonsLibCustom.helpers.isPiePlus
import java.nio.charset.StandardCharsets.UTF_8
import java.security.MessageDigest

private const val RIGHT_HASH =
...
fun PackageManager.checkSignature(packageName: String?): Boolean {
    ...
    val expectedHash = Base64.decode(RIGHT_HASH, NO_PADDING).toString(UTF_8)
