...
import com.smsnew.messenger.commonsLibCustom.models.contacts.Organization as MyOrganization
        ...
        val backgroundPaint = if (context.baseConfig.useColoredContacts) {
            ...
            Paint().apply {
                ...
                shader = LinearGradient(
                    ...
                    0f,
                    0f,
                    context.resources.getDimension(R.dimen.contact_photo_big_size),
                    0xFFa4a8b5.toInt(),
                    0xFF878b94.toInt(),
