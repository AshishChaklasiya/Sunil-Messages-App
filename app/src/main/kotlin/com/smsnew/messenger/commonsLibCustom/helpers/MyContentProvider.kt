...
object MyContentProvider {
    private const val AUTHORITY = "com.smsnew.messenger.android.provider"
    val MY_CONTENT_URI: Uri = "content://$AUTHORITY/settings".toUri()
    val FONTS_URI: Uri = "content://$AUTHORITY/fonts".toUri()

    const val PERMISSION_WRITE_GLOBAL_SETTINGS = "com.smsnew.messenger.android.permission.WRITE_GLOBAL_SETTINGS"
