...
import com.smsnew.messenger.commonsLibCustom.extensions.performHapticFeedback
import com.smsnew.messenger.commonsLibCustom.extensions.updateTextColors
import com.smsnew.messenger.commonsLibCustom.helpers.PROTECTION_PATTERN
import com.smsnew.messenger.commonsLibCustom.interfaces.BaseSecurityTab
import com.smsnew.messenger.commonsLibCustom.interfaces.HashListener
import com.smsnew.messenger.databinding.TabPatternBinding
...
class PatternTab(context: Context, attrs: AttributeSet) : BaseSecurityTab(context, attrs) {
    ...
    override fun initTab(
        ...
        if (computedHash != "") binding.patternLockTitle.setText(R.string.enter_pattern)
    }
