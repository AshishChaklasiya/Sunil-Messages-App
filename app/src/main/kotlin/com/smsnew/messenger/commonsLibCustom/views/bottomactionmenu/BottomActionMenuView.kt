package com.smsnew.messenger.commonsLibCustom.views.bottomactionmenu
...
import com.smsnew.messenger.commonsLibCustom.extensions.windowManager
...
class BottomActionMenuView : LinearLayout {
    ...
    private fun computeMaxItemsBeforeOverflow(): Int {
        val itemsToShowAsAction = items.filter { it.showAsAction && it.icon != NO_ID }
