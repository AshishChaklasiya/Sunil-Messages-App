...
import com.smsnew.messenger.databinding.DialogIconListBinding
    ...
    init {
        val view = DialogIconListBinding.inflate(activity.layoutInflater, null, false).apply {
            when (items.size) {
                2 -> {
                    arrayOf(
                        icon3Holder, icon4Holder, icon5Holder, icon6Holder, icon7Holder, icon8Holder,
                ...
                3 -> {
                    arrayOf(
                        icon4Holder, icon5Holder, icon6Holder, icon7Holder, icon8Holder,
                        icon9Holder, icon10Holder, icon11Holder, icon12Holder
                    ).forEach {
                        it.beGone()
                    }
                ...
                4 -> {
                    arrayOf(
                        icon5Holder, icon6Holder, icon7Holder, icon8Holder,
                        icon9Holder, icon10Holder, icon11Holder, icon12Holder
                    ).forEach {
                        it.beGone()
                    }
            ...
            arrayOf(
                icon1Check, icon2Check, icon3Check, icon4Check, icon5Check, icon6Check,
